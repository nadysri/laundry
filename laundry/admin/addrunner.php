...
<!--------------------bODY-------------------->
<form action="addrunner.php" method="post">
<br><br><br><br>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="rname" placeholder="Enter fullname">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <span class="form-label">PHONE NUMBER</span>
                    <input class="form-control" type="text" name="rphone" placeholder="Enter phone number">
                  </div>
                </div>
              </div>
              <div class="form-btn">
