...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE staff SET fullname= '$fullname' , phoneNo = '$phoneNo', gen='$gen', username='$username', password='password' WHERE staffID ='$staffID'";

$result = $con->query($sql); {
       echo "<script>alert('Data Updated!');window.location.href='viewstaff.php';
</script>";
}
    } else {
      $errTyp = "danger";
...
// if the form's update button is clicked, we need to process the 
          ...
          <div class="booking-form">
			...
			<div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="staffID" value="<?php echo $staffID;?>" disabled>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="phoneNo" placeholder="Enter phone number" value="<?php echo $phoneNo;?>">
              ...
              <div class="form-group">
               ...
               <span class="form-label"><input type="radio" checked="checked" name="gen" value="<?php echo $gen;?>">&nbsp; Male
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gen" value="<?php echo $gen;?>">&nbsp; Female
               </span>
