      ...
      <div class="sidebar-menu">
        <ul id="accordion-menu">
          ...
          <li>
            ...
            <ul class="submenu">
              <li><a href="addstaff.php" class="submenu" >Add</a></li>
...
<!--------------------bODY-------------------->
<form class="form" action="addprocess.php" method="post">
<br><br><br><br>
          ...
          <div class="booking-form">
            <div class="form-header">
              ...
              <div class="form-group">
               ...
               <span class="form-label"><input type="radio" checked="checked" name="gen" value="male">&nbsp; Male
