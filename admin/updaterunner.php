...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE runner SET rname= '$rname' , rphone = '$rphone' WHERE runnerID ='$runnerID'";

$result = $con->query($sql); {
       echo "<script>alert('Data Update!');window.location.href='viewrunner.php';
</script>";
}
    } else {
      $errTyp = "danger";
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="runnerID" value="<?php echo $runnerID;?>" disabled>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <span class="form-label">NAME</span>
                    <input class="form-control" type="text" name="rname" value="<?php echo $rname;?>">
                    <input type="hidden" name="runnerID" value="<?php echo $runnerID;?>">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <span class="form-label">PHONE NUMBER</span>
                    <input class="form-control" type="text" name="rphone" value="<?php echo $rphone; ?>">
                  </div>
                </div>
              </div>
              <div class="form-btn">
...
.booking-form .submit-btn {
  ...
  <?php
    ...
    header ('Location : viewrunner.php');
  }
