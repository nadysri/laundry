...
if( isset($_GET['search']) ){
    ...
    $sql = "SELECT * FROM runner WHERE runnerID ='$name'";
}
...
function check (nilai)
{
  ...
  {
    document.location.href="delrunner.php?id_delete="+nilai;
  }
}
...
<!--------------------bODY-------------------->
  ...
  <div class="table-responsive">
    ...
    ?>
          ...
          <tr>
          <td><?php echo $row['runnerID']; ?></td>
          <td><?php echo $row['rname']; ?></td>
          <td><?php echo $row['rphone']; ?></td>
          <td>
              <a href="updaterunner.php?runnerID=<?php echo $row['runnerID']; ?>" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
              <a href="javascript:check(<?php echo $row ['runnerID'];?>)"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
           </td>
          </tr> 
