...
if( isset($_GET['search']) ){
    ...
    $sql = "SELECT * FROM booking WHERE bookingID ='$name'";
}
...
function check (nilai)
{
  ...
  {
    document.location.href="delbookingstaff.php?id_delete="+nilai;
  }
}
...
<!--------------------bODY-------------------->
  ...
  <div class="table-responsive">
    ...
    ?>
          ...
          <td>
              <a href="updatestaffbooking.php?id_edit=<?php echo $row['bookingID']; ?>" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
              <a href="javascript:check(<?php echo $row ['bookingID'];?>)"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
           </td>
          </tr> 
